...
public class RNASeqWorkflowTest {
    ...
    public void createDot() {
        ...
        // new job
        CondorJob fastqFormatterR1Job = WorkflowJobFactory.createJob(++count, UBUFastqFormatterCLI.class, null).build();
        ...
        // new job
        CondorJob fastqFormatterR2Job = WorkflowJobFactory.createJob(++count, UBUFastqFormatterCLI.class, null).build();
        graph.addVertex(fastqFormatterR2Job);
        graph.addEdge(gunzipFastqR2Job, fastqFormatterR2Job);

        // new job
        CondorJob determineReadLengthJob = WorkflowJobFactory.createJob(++count, DetermineReadLengthCLI.class, null)
                .build();
        ...
        // new job
        CondorJob sam2JunctionArrayJob = WorkflowJobFactory.createJob(++count, NewSAM2JuntionCLI.class, null).build();
        ...
        // new job
        CondorJob remapUnmapped1RegexCatJob = WorkflowJobFactory.createJob(++count, RegexCatCLI.class, null).build();
        graph.addVertex(remapUnmapped1RegexCatJob);
        graph.addEdge(remappedSAMMapspliceMultiThreadJob, remapUnmapped1RegexCatJob);

        // new job
        CondorJob remapUnmapped2RegexCatJob = WorkflowJobFactory.createJob(++count, RegexCatCLI.class, null).build();
        graph.addVertex(remapUnmapped2RegexCatJob);
        graph.addEdge(remappedSAMMapspliceMultiThreadJob, remapUnmapped2RegexCatJob);

        // new job
        CondorJob alignmentHandlerMultiJob = WorkflowJobFactory
                .createJob(++count, AlignmentHandlerMultiCLI.class, null).build();
        ...
        // new job
        CondorJob filteredNormalAlignmentsFusionPairedCatJob = WorkflowJobFactory
                .createJob(++count, CatCLI.class, null).build();
        ...
        // new job
        CondorJob mapspliceMultiThreadFusionJob = WorkflowJobFactory.createJob(++count, MapSpliceMultiThreadCLI.class,
                null).build();
        ...
        // new job
        CondorJob filterOriginalFusionJob = WorkflowJobFactory.createJob(++count, FilterOriginalFusionCLI.class, null)
                .build();
        graph.addVertex(filterOriginalFusionJob);
        graph.addEdge(fusionSAM2JunctionFilterAnchorNewFormatJob, filterOriginalFusionJob);

        // new job
        CondorJob junctionDBFusionJob = WorkflowJobFactory.createJob(++count, JunctionDBFusionCLI.class, null).build();
        ...
        // new job
        CondorJob fusionUnmapped1RegexCatJob = WorkflowJobFactory.createJob(++count, RegexCatCLI.class, null).build();
        graph.addVertex(fusionUnmapped1RegexCatJob);
        graph.addEdge(mapspliceMultiThreadFusionJob, fusionUnmapped1RegexCatJob);

        // new job
        CondorJob fusionUnmapped2RegexCatJob = WorkflowJobFactory.createJob(++count, RegexCatCLI.class, null).build();
        ...
        // new job
        alignmentHandlerMultiJob = WorkflowJobFactory.createJob(++count, AlignmentHandlerMultiCLI.class, null).build();
        graph.addVertex(alignmentHandlerMultiJob);
        ...
        // new job
        CondorJob samtoolsFlagstatJob = WorkflowJobFactory.createJob(++count, SAMToolsFlagstatCLI.class, null).build();
        ...
        // new job
        CondorJob normBedExonQuantJob = WorkflowJobFactory.createJob(++count, NormBedExonQuantCLI.class, null).build();
        graph.addVertex(normBedExonQuantJob);
        graph.addEdge(coverageBedJob, normBedExonQuantJob);

        // new job
        CondorJob sortBAMByReferenceAndNameJob = WorkflowJobFactory.createJob(++count, SortByReferenceAndNameCLI.class,
                null).build();
        graph.addVertex(sortBAMByReferenceAndNameJob);
        graph.addEdge(samtoolsIndexJob, sortBAMByReferenceAndNameJob);

        // new job
        CondorJob ubuSamTranslateJob = WorkflowJobFactory.createJob(++count, UBUSamTranslateCLI.class, null).build();
        ...
        // new job
        CondorJob normalizeISOFormQuantJob = WorkflowJobFactory.createJob(++count, NormalizeQuartileCLI.class, null)
                .build();
