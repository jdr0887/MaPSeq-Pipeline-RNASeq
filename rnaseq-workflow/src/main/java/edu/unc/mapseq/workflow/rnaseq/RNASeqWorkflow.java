        ...
        for (HTSFSample htsfSample : htsfSampleSet) {
            ...
            if (readPairList.size() == 2) {
                ...
                try {
                    ...
                    // new job
                    CondorJob gunzipFastqR1Job = WorkflowJobFactory.createJob(++count, GUnZipCLI.class,
                    ...
                    // new job
                    CondorJob gunzipFastqR2Job = WorkflowJobFactory.createJob(++count, GUnZipCLI.class,
                            getWorkflowPlan(), htsfSample);
                    ...
                    // new job
                    CondorJob determineReadLengthJob = WorkflowJobFactory.createJob(++count,
                    ...
                    // new job
                    CondorJob filter1HitsJob = WorkflowJobFactory.createJob(++count, Filter1HitsCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    CondorJob bowtieBuildJob = WorkflowJobFactory.createJob(++count, BowtieBuildCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    // new job
                    CondorJob remappedRegexCatJob = WorkflowJobFactory.createJob(++count, RegexCatCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    // new job
                    CondorJob alignmentHandlerMultiJob = WorkflowJobFactory.createJob(++count,
                    ...
                    // new job
                    CondorJob filteredNormalAlignmentsFusionPairedCatJob = WorkflowJobFactory.createJob(++count,
                    ...
                    // new job
                    CondorJob filteredNormalAlignmentsSingleCatJob = WorkflowJobFactory.createJob(++count,
                            CatCLI.class, getWorkflowPlan(), htsfSample, false);
                    ...
                    // new job
                    CondorJob filteredNormalAlignmentsPairedCatJob = WorkflowJobFactory.createJob(++count,
                            CatCLI.class, getWorkflowPlan(), htsfSample, false);
                    ...
                    // new job
                    CondorJob sedJob = WorkflowJobFactory.createJob(++count, SedCLI.class, getWorkflowPlan(),
                            htsfSample, false);
                    ...
                    // new job
                    CondorJob parseClusterJob = WorkflowJobFactory.createJob(++count, ParseClusterCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    // new job
                    CondorJob filterOriginalFusionJob = WorkflowJobFactory.createJob(++count,
                    ...
                    // new job
                    CondorJob synFusionIndexBowtieBuildJob = WorkflowJobFactory.createJob(++count,
                    ...
                    // new job
                    mapspliceMultiThreadFusionJob = WorkflowJobFactory.createJob(++count,
                            MapSpliceMultiThreadCLI.class, getWorkflowPlan(), htsfSample);
                    mapspliceMultiThreadFusionJob.setSiteName(siteName);
                    mapspliceMultiThreadFusionJob.addArgument(MapSpliceMultiThreadCLI.FASTQ1,
                            remapUnmapped1RegexCatOutput.getAbsolutePath());
                    ...
                    // new job
                    CondorJob sortJob = WorkflowJobFactory.createJob(++count, SortCLI.class, getWorkflowPlan(),
                            htsfSample, false);
                    ...
                    // new job
                    CondorJob setUnmappedBitFlagJob = WorkflowJobFactory.createJob(++count,
                    ...
                    // new job
                    CondorJob samtoolsSortJob = WorkflowJobFactory.createJob(++count, SAMToolsSortCLI.class,
                            getWorkflowPlan(), htsfSample);
                    ...
                    // new job
                    CondorJob coverageBedJob = WorkflowJobFactory.createJob(++count, CoverageBedCLI.class,
                            getWorkflowPlan(), htsfSample);
                    ...
                    ubuSamTranslateJob.addArgument(UBUSamTranslateCLI.ORDER, getWorkflowBeanService().getAttributes()
                            .get("order"));
                    ...
                    // new job
                    CondorJob ubuSamFilterJob = WorkflowJobFactory.createJob(++count, UBUSamFilterCLI.class,
                            getWorkflowPlan(), htsfSample);
                    ...
                    // new job
                    CondorJob rsemISOFormsResultStripTabJob = WorkflowJobFactory.createJob(++count,
                    ...
                    // new job
                    CondorJob normalizeISOFormQuantJob = WorkflowJobFactory.createJob(++count,
