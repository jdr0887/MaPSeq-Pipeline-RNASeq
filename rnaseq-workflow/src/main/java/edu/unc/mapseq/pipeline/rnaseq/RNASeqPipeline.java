...
public class RNASeqPipeline extends AbstractPipeline {
    ...
    public Graph<CondorJob, CondorJobEdge> createGraph() throws PipelineException {
        ...
        String bowtieIndexDirectory = getPipelineBeanService().getAttributes().get("bowtieIndexDirectory");
        logger.info("bowtieIndexDirectory: {}", bowtieIndexDirectory);

        String chromosomeDirectory = getPipelineBeanService().getAttributes().get("chromosomeDirectory");
        logger.info("chromosomeDirectory: {}", chromosomeDirectory);

        String allChromosomeFiles = getPipelineBeanService().getAttributes().get("allChromosomeFiles");
        ...
        for (HTSFSample htsfSample : htsfSampleSet) {
            ...
            if (readPairList.size() == 2) {
                ...
                try {
                    ...
                    // new job
                    CondorJob determineReadLengthJob = PipelineJobFactory.createJob(++count,
                            DetermineReadLengthCLI.class, getWorkflowPlan(), htsfSample);
                    determineReadLengthJob.setSiteName(siteName);
                    determineReadLengthJob.addArgument(DetermineReadLengthCLI.INPUT,
                    ...
                    // new job
                    CondorJob readChromoSizesJob = PipelineJobFactory.createJob(++count, ReadChromoSizeCLI.class,
                            getWorkflowPlan(), htsfSample);
                    ...
                    readChromoSizesJob.addArgument(ReadChromoSizeCLI.CHROMOSOMEINDEX,
                            chromosomeIndexOutput.getAbsolutePath());
                    ...
                    // new job
                    CondorJob originalSAMMapspliceMultiThreadJob = PipelineJobFactory.createJob(++count,
                    ...
                    originalSAMMapspliceMultiThreadJob.addArgument(
                            MapSpliceMultiThreadCLI.REPORTUPTONALIGNMENTSPERREAD, 40);
                    ...
                    // new job
                    CondorJob originalSAMRegexCatJob = PipelineJobFactory.createJob(++count, RegexCatCLI.class,
                    ...
                    // new job
                    CondorJob sam2JunctionArrayJob = PipelineJobFactory.createJob(++count, NewSAM2JuntionCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    sam2JunctionArrayJob.addArgument(NewSAM2JuntionCLI.JUNCTIONFILE,
                            originalAllJunctionsFile.getAbsolutePath());
                    ...
                    sam2JunctionArrayJob.addArgument(NewSAM2JuntionCLI.READLENGTH,
                            determineReadLengthOutput.getAbsolutePath());
                    ...
                    // new job
                    CondorJob filter1HitsJob = PipelineJobFactory.createJob(++count, Filter1HitsCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    // new job
                    CondorJob filterJunctionByROCarguNonCanonicalJob = PipelineJobFactory.createJob(++count,
                    ...
                    filterJunctionByROCarguNonCanonicalJob.addArgument(
                            FilterJunctionByROCarguNonCanonicalCLI.ENTROPYWEIGHT, 0.097718);
                    filterJunctionByROCarguNonCanonicalJob.addArgument(
                            FilterJunctionByROCarguNonCanonicalCLI.LPQWEIGHT, 0.66478);
                    filterJunctionByROCarguNonCanonicalJob.addArgument(FilterJunctionByROCarguNonCanonicalCLI.MINSCORE,
                            0.719);
                    filterJunctionByROCarguNonCanonicalJob.addArgument(
                            FilterJunctionByROCarguNonCanonicalCLI.AVEMISMATCHWEIGHT, -0.21077);
                    filterJunctionByROCarguNonCanonicalJob.addArgument(
                            FilterJunctionByROCarguNonCanonicalCLI.JUNCTIONFILE,
                            canonicalFilter1HitsOutput.getAbsolutePath());
                    ...
                    filterJunctionByROCarguNonCanonicalJob.addArgument(
                            FilterJunctionByROCarguNonCanonicalCLI.INTRONWEIGHT, 0);
                    filterJunctionByROCarguNonCanonicalJob.addArgument(
                            FilterJunctionByROCarguNonCanonicalCLI.SUMLENGTHWEIGHT, 0);
                    filterJunctionByROCarguNonCanonicalJob.addArgument(
                            FilterJunctionByROCarguNonCanonicalCLI.MINFLANKCASE, 5);
                    ...
                    // new job
                    CondorJob junctionSequenceConstructionJob = PipelineJobFactory.createJob(++count,
                    ...
                    junctionSequenceConstructionJob.addArgument(JunctionSequenceConstructionCLI.JUNCTION,
                            bestJunctionOutput.getAbsolutePath());
                    junctionSequenceConstructionJob.addArgument(
                            JunctionSequenceConstructionCLI.REFERENCESEQUENCEDIRECTORY, chromosomeDirectory);
                    ...
                    junctionSequenceConstructionJob.addArgument(
                            JunctionSequenceConstructionCLI.MAXIMUMSEQUENCETHRESHOLD, 400);
                    ...
                    CondorJob bowtieBuildJob = PipelineJobFactory.createJob(++count, BowtieBuildCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    bowtieBuildJob.setSiteName(siteName);
                    bowtieBuildJob.addArgument(BowtieBuildCLI.INPUT,
                            junctionSequenceConstructionOutput.getAbsolutePath());
                    ...
                    // new job
                    CondorJob remappedSAMMapspliceMultiThreadJob = PipelineJobFactory.createJob(++count,
                            MapSpliceMultiThreadCLI.class, getWorkflowPlan(), htsfSample);
                    ...
                    remappedSAMMapspliceMultiThreadJob.addArgument(
                            MapSpliceMultiThreadCLI.REPORTUPTONALIGNMENTSPERREAD, 40);
                    ...
                    // new job
                    CondorJob remappedRegexCatJob = PipelineJobFactory.createJob(++count, RegexCatCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    remappedRegexCatJob.setSiteName(siteName);
                    remappedRegexCatJob.addArgument(RegexCatCLI.DIRECTORY, remapDir.getAbsolutePath());
                    remappedRegexCatJob.addArgument(RegexCatCLI.OUTPUT,
                            remappedSAMMapspliceMultiThreadOutput.getAbsolutePath());
                    ...
                    // new job
                    CondorJob remapUnmapped1RegexCatJob = PipelineJobFactory.createJob(++count, RegexCatCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    remapUnmapped1RegexCatJob.addArgument(RegexCatCLI.OUTPUT,
                    ...
                    // new job
                    CondorJob remapUnmapped2RegexCatJob = PipelineJobFactory.createJob(++count, RegexCatCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    remapUnmapped2RegexCatJob.addArgument(RegexCatCLI.OUTPUT,
                    ...
                    // new job
                    CondorJob alignmentHandlerMultiJob = PipelineJobFactory.createJob(++count,
                            AlignmentHandlerMultiCLI.class, getWorkflowPlan(), htsfSample, false);
                    ...
                    alignmentHandlerMultiJob.addArgument(AlignmentHandlerMultiCLI.CHROMOSOMESIZEFILE,
                            chromosomeSizesOutput.getAbsolutePath());
                    alignmentHandlerMultiJob.addArgument(AlignmentHandlerMultiCLI.ENCOMPASSINGFUSIONREGIONEXTENSION,
                            50000);
                    ...
                    // new job
                    CondorJob filteredNormalAlignmentsFusionPairedCatJob = PipelineJobFactory.createJob(++count,
                            CatCLI.class, getWorkflowPlan(), htsfSample, false);
                    ...
                    filteredNormalAlignmentsFusionPairedCatJob
                            .addArgument(CatCLI.FILES, fusionPaired.getAbsolutePath());
                    ...
                    // new job
                    CondorJob filteredNormalAlignmentsSingleCatJob = PipelineJobFactory.createJob(++count,
                            CatCLI.class, getWorkflowPlan(), htsfSample, false);
                    ...
                    File bothUnsplicedSingleAlignments = new File(remapDir,
                            remappedSAMMapspliceMultiThreadOutput.getName()
                    ...
                    // new job
                    CondorJob filteredNormalAlignmentsPairedCatJob = PipelineJobFactory.createJob(++count,
                            CatCLI.class, getWorkflowPlan(), htsfSample, false);
                    ...
                    File bothUnsplicedPairedAlignments = new File(remapDir,
                            remappedSAMMapspliceMultiThreadOutput.getName()
                    ...
                    // new job
                    CondorJob sedJob = PipelineJobFactory.createJob(++count, SedCLI.class, getWorkflowPlan(),
                            htsfSample, false);
                    ...
                    // new job
                    CondorJob parseClusterJob = PipelineJobFactory.createJob(++count, ParseClusterCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    // new job
                    CondorJob clusterJob = PipelineJobFactory.createJob(++count, ClusterCLI.class, getWorkflowPlan(),
                            htsfSample, false);
                    ...
                    // new job
                    CondorJob mapspliceMultiThreadFusionJob = PipelineJobFactory.createJob(++count,
                            MapSpliceMultiThreadCLI.class, getWorkflowPlan(), htsfSample);
                    ...
                    mapspliceMultiThreadFusionJob.addArgument(MapSpliceMultiThreadCLI.QUALITYSCALE,
                            QualityScaleType.phred33);
                    ...
                    // new job
                    CondorJob fusionSAM2JunctionFilterAnchorNewFormatJob = PipelineJobFactory.createJob(++count,
                    ...
                    File fusionSAM2JunctionFilterAnchorNewFormatOutput = new File(fusionDir,
                            "original_fusion_junction.txt");
                    fusionSAM2JunctionFilterAnchorNewFormatJob.addArgument(
                            FusionSAM2JunctionFilterAnchorNewFormatCLI.JUNCTION,
                            fusionSAM2JunctionFilterAnchorNewFormatOutput.getAbsolutePath());
                    fusionSAM2JunctionFilterAnchorNewFormatJob.addArgument(
                            FusionSAM2JunctionFilterAnchorNewFormatCLI.SAM, fusion.getAbsolutePath());
                    fusionSAM2JunctionFilterAnchorNewFormatJob.addArgument(
                            FusionSAM2JunctionFilterAnchorNewFormatCLI.MINIMUMANCHOR, 1);
                    fusionSAM2JunctionFilterAnchorNewFormatJob.addArgument(
                            FusionSAM2JunctionFilterAnchorNewFormatCLI.READLENGTH,
                            determineReadLengthOutput.getAbsolutePath());
                    fusionSAM2JunctionFilterAnchorNewFormatJob.addArgument(
                    ...
                    // new job
                    CondorJob filterOriginalFusionJob = PipelineJobFactory.createJob(++count,
                            FilterOriginalFusionCLI.class, getWorkflowPlan(), htsfSample);
                    ...
                    // new job
                    CondorJob junctionDBFusionJob = PipelineJobFactory.createJob(++count, JunctionDBFusionCLI.class,
                            getWorkflowPlan(), htsfSample);
                    junctionDBFusionJob.setSiteName(siteName);
                    junctionDBFusionJob.addArgument(JunctionDBFusionCLI.FUSIONJUNCTION,
                            remainingJunctions.getAbsolutePath());
                    ...
                    junctionDBFusionJob.addArgument(JunctionDBFusionCLI.OUTPUT,
                            junctionDBFusionOutput.getAbsolutePath());
                    junctionDBFusionJob
                    ...
                    // new job
                    CondorJob synFusionIndexBowtieBuildJob = PipelineJobFactory.createJob(++count,
                            BowtieBuildCLI.class, getWorkflowPlan(), htsfSample, false);
                    synFusionIndexBowtieBuildJob.setSiteName(siteName);
                    synFusionIndexBowtieBuildJob.addArgument(BowtieBuildCLI.INPUT,
                            junctionDBFusionOutput.getAbsolutePath());
                    File synFusionIndexPrefix = new File(fusionDir, "syn_fusion_idx_prefix");
                    synFusionIndexBowtieBuildJob.addArgument(BowtieBuildCLI.PREFIX,
                    ...
                    // new job
                    mapspliceMultiThreadFusionJob = PipelineJobFactory.createJob(++count,
                            MapSpliceMultiThreadCLI.class, getWorkflowPlan(), htsfSample);
                    mapspliceMultiThreadFusionJob.setSiteName(siteName);
                    mapspliceMultiThreadFusionJob.addArgument(MapSpliceMultiThreadCLI.FASTQ1,
                            remapUnmapped1RegexCatOutput.getAbsolutePath());
                    ...
                    // new job
                    CondorJob sortJob = PipelineJobFactory.createJob(++count, SortCLI.class, getWorkflowPlan(),
                            htsfSample, false);
                    ...
                    // new job
                    CondorJob fusionUnmapped1RegexCatJob = PipelineJobFactory.createJob(++count, RegexCatCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    fusionUnmapped1RegexCatJob.addArgument(RegexCatCLI.OUTPUT,
                    ...
                    // new job
                    CondorJob fusionUnmapped2RegexCatJob = PipelineJobFactory.createJob(++count, RegexCatCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    fusionUnmapped2RegexCatJob.addArgument(RegexCatCLI.OUTPUT,
                    ...
                    // new job
                    CondorJob fusionUnmapped1ReadsToUnmappedSAMJob = PipelineJobFactory.createJob(++count,
                    ...
                    // new job
                    CondorJob fusionUnmapped2ReadsToUnmappedSAMJob = PipelineJobFactory.createJob(++count,
                            ReadsToUnmappedSAMCLI.class, getWorkflowPlan(), htsfSample, false);
                    ...
                    // new job
                    alignmentHandlerMultiJob = PipelineJobFactory.createJob(++count, AlignmentHandlerMultiCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    alignmentHandlerMultiJob.setSiteName(siteName);
                    alignmentHandlerMultiJob.addArgument(AlignmentHandlerMultiCLI.ADDSOFTCLIP, 1);
                    alignmentHandlerMultiJob.addArgument(AlignmentHandlerMultiCLI.AVERAGEFRAGMENTLENGTH, 225);
                    ...
                    // new job
                    sortJob = PipelineJobFactory
                            .createJob(++count, SortCLI.class, getWorkflowPlan(), htsfSample, false);
                    sortJob.setSiteName(siteName);
                    ...
                    // new job
                    CondorJob setUnmappedBitFlagJob = PipelineJobFactory.createJob(++count,
                            SetUnmappedBitFlagCLI.class, getWorkflowPlan(), htsfSample, false);
                    ...
                    setUnmappedBitFlagJob.addArgument(SetUnmappedBitFlagCLI.UNMAPPEDSETBIT,
                            unmappedBitFlag.getAbsolutePath());
                    graph.addVertex(setUnmappedBitFlagJob);
                    graph.addEdge(sortJob, setUnmappedBitFlagJob);

                    // new job
                    CondorJob finalAlignmentsHeadedCatJob = PipelineJobFactory.createJob(++count, CatCLI.class,
                            getWorkflowPlan(), htsfSample, false);
                    ...
                    File fixRGOutput = new File(outputDirectory, samtoolsViewOutput.getName().replace(".bam",
                            ".fixed-rg.bam"));
                    ...
                    ubuSamJunctionJob.addArgument(UBUSamJunctionCLI.JUNCTIONS, getPipelineBeanService().getAttributes()
                            .get("junctions"));
                    ...
                    coverageBedJob.addArgument(CoverageBedCLI.BED,
                            getPipelineBeanService().getAttributes().get("compositeExons"));
                    ...
                    normBedExonQuantJob.addArgument(NormBedExonQuantCLI.COMPOSITEBED, getPipelineBeanService()
                    ...
                    ubuSamTranslateJob.addArgument(UBUSamTranslateCLI.BED, getPipelineBeanService().getAttributes()
                            .get("bed"));
                    ...
                    ubuSamTranslateJob.addArgument(UBUSamTranslateCLI.ORDER, getPipelineBeanService().getAttributes()
                            .get("order"));
                    ...
                    rsemJob.addArgument(RSEMCalculateExpressionCLI.REFERENCESEQUENCE, getPipelineBeanService()
